      ...
      <main>
        <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md mb-12">
          ...
          <div class="mb-4">
            ...
            <p class="text-xl font-bold text-blue-500 dark:text-blue-400">₺8.000,00</p>
          </div>

          <div class="mb-4">
            <p class="text-gray-700 dark:text-gray-300">
              Emlak ve gayrimenkul yada uyarlanabilecek farklı platformlar için harika bir seçenek.
            </p>
          </div>
          ...
          <button
            @click="contactSeller({ name: 'doluyer.com' })"
